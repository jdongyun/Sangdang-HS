            ...
            public void run()
            {
                ...
                mHandler.post(new Runnable()
                {
                    public void run() {
                        ...
                        DevLog.d("BreakFast", "BreakFast : " + bfstring[4] + "/ Kcal : " + bfkcalstring[4]);
                        DevLog.d("Lunch", "Lunch : " + lunchstring[4] + "/ Kcal : " + lunchkcalstring[4]);
                        DevLog.d("Dinner", "Dinner : " + dinnerstring[4] + "/ Kcal : " + dinnerkcalstring[4]);

                        if (bfstring[4] == null || "".equals(bfstring[4]) || " ".equals(bfstring[4])) {
